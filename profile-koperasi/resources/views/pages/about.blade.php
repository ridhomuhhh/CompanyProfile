...
@section('content')
  <section class="container my-5 py-5">
    <div class="row align-items-center g-5">
      ...
      <div class="col-lg-6">
        <img src="https://placehold.co/600x400/0d6efd/white?text=Koperasi+TSM" alt="Karyawan Koperasi TSM"
      ...
      <div class="timeline-container">
        ...
        <div class="timeline-content mt-5">
          <div class="timeline-item active" id="event-1998">
            ...
            <p class="lead text-muted">Koperasi "TSM" (Temprina Sejahtera Mandiri) mulai dirintis dan didirikan pada tahun
              1998.</p>
          </div>
          <div class="timeline-item" id="event-2000">
            <h3 class="fw-bold text-primary">Terdaftar Berbadan Hukum</h3>
            <p class="lead text-muted">Pada tanggal 29 Mei 2000, Koperasi TSM secara resmi terdaftar dan diakui sebagai
              badan hukum.</p>
          </div>
          <div class="timeline-item" id="event-2008">
            <h3 class="fw-bold text-primary">Perubahan Anggaran Dasar (AD/ART)</h3>
            <p class="lead text-muted">Koperasi melakukan penyesuaian dan Perubahan Anggaran Dasar / Anggaran Rumah Tangga
              (AD/ART) untuk pertama kalinya.</p>
          </div>
          <div class="timeline-item" id="event-2020">
            <h3 class="fw-bold text-primary">Menempati Kantor Baru</h3>
            <p class="lead text-muted">Untuk meningkatkan pelayanan, Koperasi TSM pindah dan mulai beroperasi di kantor
              baru yang lebih representatif.</p>
          </div>
          <div class="timeline-item" id="event-2022">
            <h3 class="fw-bold text-primary">Perubahan Anggaran Dasar (AD/ART) Kedua</h3>
            <p class="lead text-muted">Koperasi kembali melakukan pembaruan pada Anggaran Dasar / Anggaran Rumah Tangga
              (AD/ART) untuk menyesuaikan dengan perkembangan.</p>
          </div>
        </div>
      </div>
    </div>
        ...
        @foreach ($struktur as $item)
          ...
          <div class="col-md-3 col-sm-6">
            <div class="card h-100 text-center shadow-sm border-0 pt-4">
              <div class="card-body">
                <img src="{{ asset('storage/' . $item->foto) }}" class="rounded-circle mb-3"
                  alt="{{ $item->nama_anggota }}"
                  style="width: 100px; height: 100px; object-fit: cover; object-position: center;">
                <h5 class="card-title fw-bold">{{ $item->nama_anggota }}</h5>
      ...
      <div class="row g-5">
        ...
        <div class="col-lg-6">
          ...
          <ul class="list-unstyled lead">
            <li class="d-flex mb-3"><i class="bi bi-check-circle-fill text-primary me-3 fs-5"></i>Keanggotaan bersifat
              sukarela dan terbuka.</li>
            <li class="d-flex mb-3"><i class="bi bi-check-circle-fill text-primary me-3 fs-5"></i>Pengelolaan dilakukan
              secara Demokratis.</li>
            <li class="d-flex mb-3"><i class="bi bi-check-circle-fill text-primary me-3 fs-5"></i>Pembagian Sisa Hasil
              Usaha (SHU) dilakuka secara adil.</li>
            <li class="d-flex mb-3"><i class="bi bi-check-circle-fill text-primary me-3 fs-5"></i>Pemberian balas jasa
              yang terbatas terhadap modal.</li>
            <li class="d-flex mb-3"><i class="bi bi-check-circle-fill text-primary me-3 fs-5"></i>Kemandirian.</li>
            <li class="d-flex mb-3"><i class="bi bi-check-circle-fill text-primary me-3 fs-5"></i>Melaksanakan
              pendidikan perkoperasian.</li>
            <li class="d-flex mb-3"><i class="bi bi-check-circle-fill text-primary me-3 fs-5"></i>Kerjasama antar
              koperasi.</li>
          </ul>
        </div>
        ...
        <div class="col-lg-6">
          ...
          <ul class="list-unstyled lead">
            <li class="d-flex mb-3"><i class="bi bi-check-circle-fill text-primary me-3 fs-5"></i>Meningkatkan
              kesejahteraan anggota.</li>
            <li class="d-flex mb-3"><i class="bi bi-check-circle-fill text-primary me-3 fs-5"></i>Melayani kebutuhan
              anggota.</li>
            <li class="d-flex mb-3"><i class="bi bi-check-circle-fill text-primary me-3 fs-5"></i>Memberikan bantuan
              peminjaman modal.</li>
          </ul>
        </div>
