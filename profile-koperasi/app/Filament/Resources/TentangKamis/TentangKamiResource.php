...
class TentangKamiResource extends Resource
{
    ...
    protected static ?string $recordTitleAttribute = 'tentangkami';
    protected static ?string $navigationLabel = 'Tentang Kami'; // Label di Menu Kiri
    protected static ?string $modelLabel = 'Tentang Kami';      // Label di Judul Halaman
    protected static ?string $pluralModelLabel = 'Tentang Kami'; // Label di Breadcrumb
